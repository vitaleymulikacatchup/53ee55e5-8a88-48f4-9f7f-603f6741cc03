...
export const metadata: Metadata = {
  title: "Pizzeria | Delicious Pizza",
  description: "Welcome to our pizzeria! Enjoy delicious pizzas made with love.",
  keywords: "pizzeria, pizza, food, dine-in, order online",
  openGraph: {
    title: "Pizzeria | Delicious Pizza",
    description: "Enjoy the best pizza in town, made with fresh ingredients and genuine passion.",
    type: "website",
    images: [{ url: "https://images.pexels.com/photos/708587/pexels-photo-708587.jpeg?auto=compress&cs=tinysrgb&h=650&w=940", alt: "Delicious pizza" }]
  },
  twitter: {
